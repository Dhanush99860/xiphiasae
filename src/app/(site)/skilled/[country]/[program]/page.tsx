...
import { getSkilledCountrySlugs, getSkilledPrograms, loadProgramPageSections } from "@/lib/skilled-content";
...
export async function generateStaticParams() {
  return getSkilledCountrySlugs().flatMap((c) => getSkilledPrograms(c).map((p) => ({ country: c, program: p.programSlug })));
}
