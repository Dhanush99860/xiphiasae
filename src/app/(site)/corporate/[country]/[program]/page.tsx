...
export async function generateMetadata(props: { params: Promise<{ country: string; program: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    const rawD = (m.tagline as string | undefined) ?? `${m.title} — ${m.country} corporate mobility route. Arranged end-to-end by XIPHIAS, Dubai.`;
